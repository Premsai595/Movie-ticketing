class Movie_Booking:
    def __init__(self):
        print("Welcome To RRR Movie".center(25, "*"))
        print("Please seating capacity Of the Movie")
        self.rows = input("Enter Number of rows you need:  ")
        self.columns = input("Enter number of columns you need:  ")
    ...
    def Buy_ticket(self):
        ...
        print(" BOOKING COUNTER ".center(25, "*"))
                    ...
                    if self.rows % 2 == 0:
                        ...
                        if self.r <= ((self.rows // 2)):
                            ...
                            if self.opinion == 'yes':
                                ...
                                pass
                print("SCREEN IS THIS SIDE".center(25, "*"))
                for m in self.row:
                    for n in m:
                        print(n, end=' ')
                    print()
    ...
    def get_details(self):
        print("DETAILS OF CUSTOMER".center(25, "*"))
        try:
